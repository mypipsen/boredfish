...
-- CreateEnum
CREATE TYPE "UserMediaStatus" AS ENUM ('watchlist', 'archived');
...
-- AddForeignKey
ALTER TABLE "user_media" ADD CONSTRAINT "user_media_mediaId_fkey" FOREIGN KEY ("mediaId") REFERENCES "media"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
